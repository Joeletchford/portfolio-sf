...
The image system created for this year's annual was rooted in the idea that both planes and trains have an audible rhythm when in motion. This rhythm is — for the most part — methodical and structured, but it is not devoid of subtle idiosyncrasies. This balance of both cadence and happenstance is what influenced the images and overall system.
...
<p class=" mt0 w-100 dib bb mb5 pb3"/>
<!-- h2 -->
 <p class="alcove f4 f3-ns">Alternative proposed concept</p>

My alternative concept focused on a responsive type treatment which itself was based on momentum. The hero type also responded well to various screen and paper sizes for the web and print annual.
